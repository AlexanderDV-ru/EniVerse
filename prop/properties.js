/*--- Name: EniVerses/Vesion: 0.2.5a/Authors: AlexanderDV/Description: Properties EniVerses .js. ---*/
//Properties
var props	=	{}
props.syntax	=	{
	inSyms	:	"$",
...
add(`Gravity Falls
	@Sources[y]	!	#Fiction.#Multserial.Gravity Falls
	Objects
		#Artefacts
			#r-4[y]
				#Diaries
		...
		#Mind
			#r-6[y]
				#Demon
					Bill Cipher`)
add(`Fineas and Ferb
	@Sources[y]	!	#Fiction.#Mult.Fineas and Ferb`)
add(`Infinity Story`)
add(`Collectioner`)
